...
console.log("User's input " + analyzeColor);
...
if (confirmNumberInput === true) {
    ...
    (confirmNumberInput % 2 === 0) ? alert("You entered an even numebr") : alert("You entered an odd number");
    (confirmNumberInput >= 0) ? alert("You entered a positve number") : alert("You entered a negative number");
